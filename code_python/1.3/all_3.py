...
# region Simple Harris Corner Detector
# ------------------------------------------------------------------------------
...
# region Harris Corner Detector Block Size
# ------------------------------------------------------------------------------
...
# region Harris Corner Detector Sobel Aperture
# ------------------------------------------------------------------------------
...
# region Harris Corner Detector Harris Parameter
# ------------------------------------------------------------------------------
...
# region Animation Harris Corner Detector
# ------------------------------------------------------------------------------
...
@click.option("--image", prompt="Path",
              ...
              help="The path to the image")
@click.option("--bsizes",
              default=str(list(range(1, 4, 1))),
              help="Neighborhood size")
@click.option("--ksizes",
              default=str(list(range(3, 8, 2))),
              help="Aperture parameter for the Sobel operator")
@click.option("--ks",
              default=str(list(np.array([0.02, 0.04, 0.08]))),
              help="Harris detector free parameter")
@click.option("--threshold",
              default=0.01,
              type=float,
